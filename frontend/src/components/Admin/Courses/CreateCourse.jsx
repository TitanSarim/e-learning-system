...
const CreateCourse = () => {
  ...
  const handleWeeksChange = (event) => {
    ...
    setVideoDivsArray(
      Array.from({ length: selectedWeeks }, (_, weekIndex) => createEmptyWeek())
    );
  };
    ...
    if (selectedFile) {
      ...
      image.onload = () => {
        ...
        if (
          ...
          toast.error(
            "Image dimensions must be between 280-330px width and 640-700px height"
          );
      ...
      return prevVideoDivsArray.map((week, wIndex) =>
        wIndex === weekIndex
          ? {
              ...
              videos: [
                ...week.videos,
                { id: newId, videoDesc: "", videoFile: null },
              ],
            }
          : week
      );
    ...
    setVideoDivsArray((prevVideoDivsArray) =>
      prevVideoDivsArray.map((week, wIndex) =>
        wIndex === weekIndex
          ? {
              ...week,
              videos: week.videos.filter((video) => video.id !== divId),
            }
          : week
      )
    );
          ...
          <div className="admin-create-course-container">
            ...
            <div className="admin-create-course-input-containers">
              ...
              <div className="admin-create-course-input">
                ...
                <input
                  placeholder="Select 5 tags saprated by comma ,"
                  value={tags}
              ...
              <div>
                ...
                {!thumbnailFile ? (
                  <p>
                    No File{" "}
                    <span>
                      Image height greater then 280px and smaller then 330px,
                      image width greater then 640px and smaller then 700px
                    </span>{" "}
                  </p>
                ) : (
                  <img
                ...
                >
                  <div className="admin-create-course-adding-videos-addition">
                    ...
                    <div className="admin-create-course-adding-videos-input">
                      ...
                      <input
                        type="text"
                        placeholder="Title for week"
                        onChange={(e) => handleWeekTitleChange(weekIndex, e)}
                      />
                    </div>
                  </div>

                  <>
                    {videoDivsArray[weekIndex]?.videos.map((video, index) => {
                      return (
                        <div
                          key={video.id}
                          className="admin-create-course-adding-videos-wrapper"
                        >
                          <div className="admin-create-course-adding-videos-seperater">
                            <div></div>
                            <p>Video {index + 1}</p>
                            <div></div>
                          </div>
                          <div className="admin-create-course-adding-video">
                            <div className="admin-create-course-adding-videos-file-video">
                              ...
                              <div>
                                ...
                                {!video.videoFile ? (
                                  ...
                                  <p>
                                    <span>
                                      {video.videoFile?.name.substring(0, 3)}...
                                    </span>{" "}
                                    <span>
                                      {getExtension(video.videoFile?.name)}
                                    </span>
                                  </p>
                                )}
                              </div>
                            ...
                            <div className="admin-create-course-adding-videos-btn">
                              ...
                              <button
                                onClick={() =>
                                  handleDeleteVideo(weekIndex, video.id)
                                }
                              >
                          ...
                          <div className="admin-create-course-adding-videos-text-area">
                            <p>
                              Add video description <span>*</span>
                            </p>
                            <ReactQuill
                              theme="snow"
                              value={video.videoDesc}
                              onChange={(value) =>
                                handleVideoEditorChange(
                                  weekIndex,
                                  video.id,
                                  value
                                )
