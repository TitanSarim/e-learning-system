...
const {createJob, updateJob, updateJobStatus, getAllHrJob, getSingleHrJob, deleteHrJob, getAllJobsPublic, jobApply, getRelatedKeyWords} = require('../controllers/JobController')
...
router.route("/get-job-search-results").post(getRelatedKeyWords)
